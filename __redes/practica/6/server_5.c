...
int main(int argc, char const *argv[]) {
	...
	char mensaje[] = "este mensaje tiene mas de 10 caracteres\0";
	...
	if (listen(creacion, 6) < 0) {					// El servidor se ponga a escuchar las conexiones (4, núm de solicitudes que pueden estar en la cola)
